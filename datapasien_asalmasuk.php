...
<main>
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">F. Data Pasien Berdasarkan Asal Masuk</h1>
            ...
            <div class="card-header py-3">
                <form action="export13.php" id="cari" method="post" class="form-inline">
                    ...
                    <div class="form-group">
                        <button id="print" onclick="printContent('tabel_asal')" class="btn btn-primary">Print</button>
                    </div>
                </form>

            </div>
            <div class="card-body">
                <div class="table-responsive" id="tabel_asal">
