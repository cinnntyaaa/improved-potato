...
header('Content-Disposition: attachment; filename="MorbiditasRJ ' . date('Ymd', strtotime($tanggal)) . '-' . date('Ymd', strtotime($tanggal2)) . '.xls"');
...
<body id="page-top">
    ...
    $no = 1;
    $sql = "CALL RL_4_B ('" . $tanggal . "', '" . $tanggal2 . "');";
    $outp = array();
    // Execute multi query
    ...
    ?>
        <span style="color:black; font-weight:bolder; font-size:larger">RL 4B Morbiditas Pasien Rawat Jalan</span>
        <table border="1" width="100%">
            ...
            foreach ($outp as $data) {
                echo "
                    ...
                    <td style='text-align: right'>" . $data['sum_men_new'] . "</td>
                    <td style='text-align: right'>" . $data['sum_women_new'] . "</td>
