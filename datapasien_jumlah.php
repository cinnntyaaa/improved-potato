...
<main>
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">A. Data Pasien Berdasarkan Jumlah Pasien Dalam 1 Periode</h1>
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive" id="tabel">
                    ...
                    <table class="table table-bordered table-fixed" id="jiwa" cellspacing="0" style="align-content: center; color:black;">
                        <thead style="text-align: center;">
                            <tr>
                                <th>Jumlah Pasien Dalam Satu Periode</th>
                            </tr>
                        </thead>
                        <tbody id="tabel_jumlah">
...
<script>
    ...
    $('body').on('click', '#submit', function(e) {
        ...
        $.ajax({
            url: 'proses_datapasienJumlah.php',
            type: 'POST',
            data: {
                tanggal: tanggal1,
                tanggal2: tanggal2
