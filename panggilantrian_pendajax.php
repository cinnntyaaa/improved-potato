...
while ($data = mysqli_fetch_array($query)) {
    echo "
                                          <tr>
                                            ...
                                            <td>" . $data["tanggal"] . "</td>
                                            <td>" . $data["status"] . "</td>
                                            <td style='text-align: center;'><form action='panggilantrian.php' method='post'><input type='hidden' name='id_antrian' value='" . $data["id_antrian"] . "'/><input type='hidden' name='no_antrian' value='" . $data["no_antrian"] . "'/><input class='btn btn-primary' type='submit' value='Panggil'/></form></td>
                                          </tr>";
    $no++;
}
