...
<main>
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">I. Data Pasien Berdasarkan DPJP (Dokter Penanggung Jawab)</h1>
                ...
                <div class="table-responsive" id="tabel">
                    ...
                    <table class="table table-bordered table-fixed" id="jiwa" cellspacing="0" style="align-content: center; color:black;">
                        <thead style="text-align: center;">
                            <tr>
                                <th>No.</th>
                                <th>DPJP (Dokter Penanggung Jawab)</th>
                                <th>Jumlah</th>
                            </tr>
                        </thead>
                        <tbody id="tabel_dpjp">
