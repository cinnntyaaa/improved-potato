...
<main>
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">RL 3.11 Kegiatan Kesehatan Jiwa</h1>
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <form action="export9.php" id="cari" method="post" class="form-inline">
