...
<main>
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">D. Data Pasien Berdasarkan Pekerjaan</h1>
            ...
            <div class="card-header py-3">
                <form action="export13.php" id="cari" method="post" class="form-inline">
                    ...
                    <div class="form-group">
                        <button id="print" onclick="printContent('tabel_work')" class="btn btn-primary">Print</button>
                    </div>
                </form>

            </div>
            <div class="card-body">
                <div class="table-responsive" id="tabel_work">
...
<script>
    ...
    $('body').on('click', '#submit', function(e) {
        ...
        $.ajax({
            url: 'proses_datapasienPekerjaan.php',
            type: 'POST',
            data: {
                tanggal: tanggal1,
                tanggal2: tanggal2
