...
<main>
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">RL 3.15 Cara Bayar</h1>
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <form action="export6.php" id="cari" method="post" class="form-inline">
            ...
            <div class="card-body">
                <div class="table-responsive" id="tabel">
                    ...
                    <table class="table table-bordered table-fixed" id="bayar" cellspacing="0" style="align-content: center; color:black;">
