...
header('Content-Disposition: attachment; filename="KegiatanRadiologi ' . date('Ymd', strtotime($tanggal)) . '-' . date('Ymd', strtotime($tanggal2)) . '.xls"');
...
<body id="page-top">
    ...
    ?>
        <span style="color:black; font-weight:bolder;">RL 3.7 Kegiatan Radiologi</span>
