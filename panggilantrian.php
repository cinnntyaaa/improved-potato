...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link active" href="panggilantrian_pend.php">
            ...
            <div class="card-body">
              <div class="row">
                <form action="" method="post">
                  ...
                  <button class="btn btn-primary btn-lg m-2" type="submit">Panggil</button>
                </form>

                <button class="btn btn-primary btn-lg m-2" onclick="location.href='panggilantrian_pend.php'" type="button">Lewati</button>

                <form action="panggilselesai_pend.php" id="selesai" method="post">
                  <button class="btn btn-primary btn-lg m-2" id="selesai2" type="submit">Sudah Datang</button>
                  <input type="hidden" name="id_antrian" value="<?php echo $id_antrian; ?>">
                </form>
              </div>
  ...
  <script>
    $('#selesai').on('submit', function() {
      $.ajax({
        url: "panggilselesai_pend.php", //the page containing php script
