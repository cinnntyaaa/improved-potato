...
<main>
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">RL 3.8 Pemeriksaan Laboratorium</h1>
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive" id="tabel">
                    ...
                    <table class="table table-bordered table-fixed" id="lab" cellspacing="0" style="align-content: center; color:black;">
                        <thead style="text-align: center;">
                            ...
                            <tr>
                                <th colspan="3">Patologi Klinik</th>
                            </tr>
                        </thead>
                        <tbody id="laborat">
